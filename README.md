...
I've learnt about the <picture> element and class naming convention e.g "product\_\_img" meaning image which is part of the product class.
I've used
...
I've learnt that it's good to start styling with a CSS reset to remove any browser default styling.

I've learnt about CSS custom properties - custom variables. They need to be fefined inside of a selector, mainly in :root element of the page. It is higher specificity than html element. They become global properties cascading down. They are defined as --name: value; The two dashes tell the browser that they are custom properties.
To use them, we use the following: property: var(--name).
I've also learned about locally scoped custom properties which I've used in the product class in this project.
